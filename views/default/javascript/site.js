...
//添加收藏夹
function favorite_add_ajax(goods_id,seller_id)
{
	$.getJSON(creatUrl("simple/favorite_add"),{"seller_id":seller_id,"goods_id":goods_id,"random":Math.random()},function(content){
		alert(content.message);
	});
}
