...
<div class="wrapper clearfix">
	<div class="sidebar f_r">
		...
		<div class="group_on box m_10">
			...
			<div class="cont">
				<ul class="ranklist">
					...
					<?php foreach(apple::go('getRegimentList') as $key => $item){?>
					<li class="current">
						<?php $tmpId=$item['id'];?>
		...
		<div class="buying box m_10">
			...
			<div class="cont clearfix">
				<ul class="prolist">
					<?php foreach(apple::go('getPromotionList',5) as $key => $item){?>
		...
		<div class="box m_10">
			...
			<div class="cont">
				<ul class="list">
					<?php foreach(apple::go('getAnnouncementList',5) as $key => $item){?>
					<?php $tmpId=$item['id'];?>
		...
		<div class="box m_10">
			...
			<div class="cont">
				<ul class="list">
				<?php foreach(apple::go('getProrule') as $key => $item){?>
		...
		<div class="box m_10">
			...
			<div class="tag cont t_l">
				<?php foreach(apple::go('getKeywordList',5) as $key => $item){?>
	...
	<div class="main f_l">
		...
		<div class="comment box m_10">
			...
			<div class="cont clearfix">
				<?php foreach(apple::go('getCommentList',6) as $key => $item){?>
				<dl class="no_bg">
