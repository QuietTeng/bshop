...
<div class="wrapper clearfix container_2">
		...
		<div class="box m_10">
			...
			<div class="content">
				<ul class="ranklist" id='ranklist'>
					<?php foreach(apple::go('getCategoryExtendListByCategoryid',array('#categroy_id#',$this->childId)) as $key => $item){?>
				  	<li>
	...
	<div class="main f_r">
		<!--推荐商品-->
		<?php $pro_list = apple::go('getCategoryExtendByCommendid',array('#childId#',$this->childId))?>
	  	<?php if($pro_list){?>
